...
namespace Wyn.Data.Adapter.SqlServer
{
    public class SqlServerDbAdapter : DbAdapterAbstract
    {
        ...
        public override IDbConnection NewConnection(string connectionString) => new SqlConnection(connectionString);
        ...
        public override Guid CreateSequentialGuid() => GuidHelper.Create(SequentialGuidType.SequentialAtEnd);
