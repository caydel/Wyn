...
namespace Wyn.Data.Adapter.SqlServer
{
    ...
    public class SqlServerSchemaProvider : ISchemaProvider
    {
        ...
        public SqlServerSchemaProvider(IDbConnection con) => _con = con;

        public SqlServerSchemaProvider(string connectionString) => _con = new SqlConnection(connectionString);
