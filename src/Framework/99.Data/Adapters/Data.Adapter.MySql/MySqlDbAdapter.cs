...
namespace Wyn.Data.Adapter.MySql
{
    public class MySqlDbAdapter : DbAdapterAbstract
    {
        ...
        public override IDbConnection NewConnection(string connectionString) => new MySqlConnection(connectionString);
        ...
        public override string GenerateFirstSql(string @select, string table, string @where, string sort, string groupBy = null, string having = null) 
            => GeneratePagingSql(select, table, where, sort, 0, 1, groupBy, having);
        ...
        public override void ResolveColumn(IColumnDescriptor columnDescriptor)
        {
            ...
            switch (typeCode)
            {
                ...
                case TypeCode.DateTime:
                    if (!isNullable)
                    {
                        columnDescriptor.DefaultValue = "CURRENT_TIMESTAMP(0)";
                    }
        ...
        public override Guid CreateSequentialGuid() => GuidHelper.Create(SequentialGuidType.SequentialAsString);
