...
namespace Wyn.Data.Adapter.Sqlite
{
    ...
    {
        public SqliteDbAdapter() => SqlMapper.AddTypeHandler(new GuidTypeHandler());
        ...
        public override IDbConnection NewConnection(string connectionString) => new SqliteConnection(connectionString);
