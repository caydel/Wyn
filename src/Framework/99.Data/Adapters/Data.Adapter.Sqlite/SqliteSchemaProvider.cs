...
namespace Wyn.Data.Adapter.Sqlite
{
    ...
    public class SqliteSchemaProvider : ISchemaProvider
    {
        ...
        public SqliteSchemaProvider(IDbConnection con) => _con = con;

        public SqliteSchemaProvider(string connectionString) => _con = new SqliteConnection(connectionString);

        public bool IsExistsDatabase(string database) => throw new Exception("Sqlite不支持该方法~");
        ...
        public List<DatabaseSchema> GetDatabases() => throw new Exception("Sqlite不支持该方法~");

        public DatabaseSchema GetDatabase(string database) => throw new Exception("Sqlite不支持该方法~");
        ...
        public void CreateDatabase(string database) => throw new Exception("Sqlite不支持该方法~");
    }
}
