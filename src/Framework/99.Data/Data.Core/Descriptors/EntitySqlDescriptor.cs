...
namespace Wyn.Data.Core.Descriptors
{
    ...
    internal class EntitySqlDescriptor : IEntitySqlDescriptor
    {
        ...
        /// <returns></returns>
        public string GetAdd(string tableName) => tableName.IsNull() ? _defaultAdd : FormatSql(_add, tableName);
        ...
        /// <param name="tableName"></param>
        /// <returns></returns>
        public string GetBatchAdd(string tableName) => tableName.IsNull() ? _defaultBatchAdd : FormatSql(_batchAdd, tableName);
        ...
        /// <param name="tableName"></param>
        /// <returns></returns>
        public string GetDeleteSingle(string tableName) => tableName.IsNull() ? _defaultDeleteSingle : FormatSql(_deleteSingle, tableName);
        ...
        /// <param name="tableName"></param>
        /// <returns></returns>
        public string GetDelete(string tableName) => tableName.IsNull() ? _defaultDelete : FormatSql(_delete, tableName);
        ...
        /// <param name="tableName"></param>
        /// <returns></returns>
        public string GetSoftDeleteSingle(string tableName) => tableName.IsNull() ? _defaultSoftDeleteSingle : FormatSql(_softDeleteSingle, tableName);
        ...
        /// <param name="tableName"></param>
        /// <returns></returns>
        public string GetSoftDelete(string tableName) => tableName.IsNull() ? _defaultSoftDelete : FormatSql(_softDelete, tableName);
        ...
        /// <param name="tableName"></param>
        /// <returns></returns>
        public string GetUpdateSingle(string tableName) => tableName.IsNull() ? _defaultUpdateSingle : FormatSql(_updateSingle, tableName);
        ...
        /// <param name="tableName"></param>
        /// <returns></returns>
        public string GetUpdate(string tableName) => tableName.IsNull() ? _defaultUpdate : FormatSql(_update, tableName);
        ...
        /// <param name="tableName"></param>
        /// <returns></returns>
        public string GetGet(string tableName) => tableName.IsNull() ? _defaultGet : FormatSql(_get, tableName);
        ...
        /// <param name="tableName"></param>
        /// <returns></returns>
        public string GetGetAndRowLock(string tableName) => tableName.IsNull() ? _defaultGetAndRowLock : FormatSql(_getAndRowLock, tableName);
        ...
        /// <param name="tableName"></param>
        /// <returns></returns>
        public string GetGetAndNoLock(string tableName) => tableName.IsNull() ? _defaultGetAndNoLock : FormatSql(_getAndNoLock, tableName);
        ...
        /// <param name="tableName"></param>
        /// <returns></returns>
        public string GetQuery(string tableName) => tableName.IsNull() ? _defaultQuery : FormatSql(_query, tableName);
        ...
        /// <param name="tableName"></param>
        /// <returns></returns>
        public string GetExists(string tableName) => tableName.IsNull() ? _defaultExists : FormatSql(_exists, tableName);
        ...
        /// <returns></returns>
        private string FormatSql(string sql, string tableName = null) => string.Format(sql, _adapter.AppendQuote(tableName ?? _tableName));
