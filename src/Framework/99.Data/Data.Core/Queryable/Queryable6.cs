...
namespace Wyn.Data.Core.Queryable
{
    internal class Queryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6> : Queryable, IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6> where TEntity : IEntity, new() where TEntity2 : IEntity, new() where TEntity3 : IEntity, new() where TEntity4 : IEntity, new() where TEntity5 : IEntity, new() where TEntity6 : IEntity, new()
    {
        ...
        public IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6> OrderBy(string field)
        {
            _queryBody.SetSort(field, SortType.Asc);
            return this;
        }

        public IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6> OrderByDescending(string field)
        {
        ...
        public IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6> Where(string whereSql)
        {
        ...
        public IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6> WhereIf(bool condition, string whereSql)
        {
            if (condition)
            {
                _queryBody.SetWhere(whereSql);
        ...
        public IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6> WhereIfElse(bool condition, string ifWhereSql, string elseWhereSql)
        {
        ...
        public IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6> WhereNotNull(string condition, string whereSql)
        {
            if (condition.NotNull())
            {
                _queryBody.SetWhere(whereSql);
        ...
        public IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6> WhereNotNull(string condition, string ifWhereSql, string elseWhereSql)
        {
        ...
        public IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6> WhereNotNull(object condition, string whereSql)
        {
            if (condition != null)
            {
                _queryBody.SetWhere(whereSql);
        ...
        public IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6> WhereNotNull(object condition, string ifWhereSql, string elseWhereSql)
        {
        ...
        public IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6> WhereNotEmpty(Guid condition, string whereSql)
        {
            if (condition != Guid.Empty)
            {
                _queryBody.SetWhere(whereSql);
        ...
        public IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6> WhereNotEmpty(Guid condition, string ifWhereSql, string elseWhereSql)
        {
        ...
        public IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6> Limit(int skip, int take)
        {
        ...
        public IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6> Select<TResult>(string sql)
        {
        ...
        public IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6> NotFilterSoftDeleted()
        {
        ...
        public IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5, TEntity6> NotFilterTenant()
        {
