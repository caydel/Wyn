        ...
        public IConfig Get(Type implementType)
        {
            ...
            if (descriptor.Instance == null)
            {
                ...
                if (json.IsNull())
                {
                    ...
                    descriptor.Instance = (IConfig)JsonHelper.Deserialize(json, implementType);
            }
        ...
        public IConfig Get(string code, ConfigType type)
        {
            ...
            if (descriptor.Instance == null)
            {
                ...
                if (json.IsNull())
                {
                    ...
                    descriptor.Instance = (IConfig)JsonHelper.Deserialize(json, descriptor.ImplementType);
            }
