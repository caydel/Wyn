...
namespace Wyn.Config
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddConfig(this IServiceCollection services)
        {
            ...
            // 添加内存配置存储实现
            services.TryAddScoped<IConfigStorageProvider, Core.MemoryConfigStorageProvider>();
            // 配置实例提供器
            services.TryAddSingleton<IConfigProvider, Core.ConfigProvider>();
        ...
        public static IServiceCollection AddConfigWithRedis(this IServiceCollection services)
        {
            ...
            // 配置实例提供器
            services.AddSingleton<IConfigProvider, Redis.ConfigProvider>();
