...
namespace Wyn.Utils.Extensions
{
    ...
    public static class EnumExtensions
    {
        ...
        /// 包含UnKnown选项
        /// </summary>
        private static readonly ConcurrentDictionary<RuntimeTypeHandle, List<OptionResultModel>> ListCache = 
            new ConcurrentDictionary<RuntimeTypeHandle, List<OptionResultModel>>();

        /// <summary>
        /// 不包含UnKnown选项
        /// </summary>
        private static readonly ConcurrentDictionary<RuntimeTypeHandle, List<OptionResultModel>> ListCacheNoIgnore = 
            new ConcurrentDictionary<RuntimeTypeHandle, List<OptionResultModel>>();

        /// <summary>
        /// 获取枚举类型的Description说明
        /// </summary>
        /// <param name="value">指定的枚举</param>
        /// <returns>Description说明</returns>
        public static string ToDescription(this Enum value)
        {
            var type = value.GetType();
            var info = type.GetField(value.ToString());
            var key = type.FullName + info?.Name;
            if (DescriptionCache.TryGetValue(key, out var desc)) return desc;
        ...
        /// </summary>
        /// <param name="value">指定的枚举</param>
        /// <param name="ignoreUnKnown">是否忽略UnKnown选项</param>
        /// <returns>转换后的可选项列表</returns>
