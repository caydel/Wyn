...
namespace Wyn.Data.Abstractions
{
    ...
    public interface IRepository<TEntity> : IRepository where TEntity : IEntity, new()
    {
        ...
        /// </summary>
        /// <returns></returns>
        System.Linq.IQueryable<TEntity> Find();
        ...
        /// <returns></returns>
        System.Linq.IQueryable<TEntity> Find(Expression<Func<TEntity, bool>> expression);
        ...
        /// <returns></returns>
        System.Linq.IQueryable<TEntity> Find(Expression<Func<TEntity, bool>> expression, bool noLock);
    }
}
