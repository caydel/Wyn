...
{
    public interface IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> : IQueryable
        ...
        where TEntity5 : IEntity, new()
    {
        ...
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> OrderBy(string field);
        ...
        /// <param name="field">排序字段名称</param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> OrderByDescending(string field);
        ...
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> Where(string whereSql);
        ...
        /// <param name="whereSql">查询条件</param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> WhereIf(bool condition, string whereSql);
        ...
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> WhereIfElse(bool condition, string ifWhereSql, string elseWhereSql);
        ...
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> WhereNotNull(string condition, string whereSql);
        ...
        /// <param name="elseWhereSql"></param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> WhereNotNull(string condition, string ifWhereSql, string elseWhereSql);
        ...
        /// <param name="whereSql"></param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> WhereNotNull(object condition, string whereSql);
        ...
        /// <param name="elseWhereSql"></param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> WhereNotNull(object condition, string ifWhereSql, string elseWhereSql);
        ...
        /// <param name="whereSql"></param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> WhereNotEmpty(Guid condition, string whereSql);
        ...
        /// <param name="elseWhereSql"></param>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> WhereNotEmpty(Guid condition, string ifWhereSql, string elseWhereSql);
        ...
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> Select<TResult>(string sql);
        ...
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> Limit(int skip, int take);
        ...
        /// </summary>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> NotFilterSoftDeleted();
        ...
        /// </summary>
        /// <returns></returns>
        IQueryable<TEntity, TEntity2, TEntity3, TEntity4, TEntity5> NotFilterTenant();
