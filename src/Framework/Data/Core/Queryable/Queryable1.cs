...
{
    internal class Queryable<TEntity> : Queryable, Abstractions.Queryable.IQueryable<TEntity> where TEntity : IEntity, new()
    {
        ...
        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.OrderBy(string field)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.OrderByDescending(string field)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.OrderBy<TKey>(Expression<Func<TEntity, TKey>> expression)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.OrderByDescending<TKey>(Expression<Func<TEntity, TKey>> expression)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.Where(Expression<Func<TEntity, bool>> expression)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.Where(string whereSql)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.WhereIf(bool condition, Expression<Func<TEntity, bool>> expression)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.WhereIf(bool condition, string whereSql)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.WhereIfElse(bool condition, Expression<Func<TEntity, bool>> ifExpression, Expression<Func<TEntity, bool>> elseExpression)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.WhereIfElse(bool condition, string ifWhereSql, string elseWhereSql)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.WhereNotNull(string condition, Expression<Func<TEntity, bool>> expression)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.WhereNotNull(string condition, Expression<Func<TEntity, bool>> ifExpression, Expression<Func<TEntity, bool>> elseExpression)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.WhereNotNull(string condition, string whereSql)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.WhereNotNull(string condition, string ifWhereSql, string elseWhereSql)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.WhereNotNull(object condition, Expression<Func<TEntity, bool>> expression)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.WhereNotNull(object condition, Expression<Func<TEntity, bool>> ifExpression, Expression<Func<TEntity, bool>> elseExpression)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.WhereNotNull(object condition, string whereSql)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.WhereNotNull(object condition, string ifWhereSql, string elseWhereSql)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.WhereNotEmpty(Guid condition, Expression<Func<TEntity, bool>> expression)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.WhereNotEmpty(Guid condition, string whereSql)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.WhereNotEmpty(Guid condition, Expression<Func<TEntity, bool>> ifExpression, Expression<Func<TEntity, bool>> elseExpression)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.WhereNotEmpty(Guid condition, string ifWhereSql, string elseWhereSql)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.SubQueryEqual<TKey>(Expression<Func<TEntity, TKey>> key, Abstractions.Queryable.IQueryable queryable)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.SubQueryNotEqual<TKey>(Expression<Func<TEntity, TKey>> key, Abstractions.Queryable.IQueryable queryable)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.SubQueryGreaterThan<TKey>(Expression<Func<TEntity, TKey>> key, Abstractions.Queryable.IQueryable queryable)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.SubQueryGreaterThanOrEqual<TKey>(Expression<Func<TEntity, TKey>> key, Abstractions.Queryable.IQueryable queryable)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.SubQueryLessThan<TKey>(Expression<Func<TEntity, TKey>> key, Abstractions.Queryable.IQueryable queryable)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.SubQueryLessThanOrEqual<TKey>(Expression<Func<TEntity, TKey>> key, Abstractions.Queryable.IQueryable queryable)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.SubQueryIn<TKey>(Expression<Func<TEntity, TKey>> key, Abstractions.Queryable.IQueryable queryable)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.SubQueryNotIn<TKey>(Expression<Func<TEntity, TKey>> key, Abstractions.Queryable.IQueryable queryable)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.Select<TResult>(Expression<Func<TEntity, TResult>> expression)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.Select<TResult>(string sql)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.SelectExclude<TResult>(Expression<Func<TEntity, TResult>> expression)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.Limit(int skip, int take)
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.NotFilterSoftDeleted()
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.NotFilterTenant()
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.Copy()
        {
            throw new NotImplementedException();
        }

        Abstractions.Queryable.IQueryable<TEntity> Abstractions.Queryable.IQueryable<TEntity>.UseUow(IUnitOfWork uow)
        {
            throw new NotImplementedException();
        }
